  ...
  <div className='footerDiv' >
    <div className='flex-container'>
      <div className='flex-item-left'>
        ...
        <p className='p1'> Do you want to be even more successfull? Learn to love learning and growth. The more effort you put into your improving your skills.</p>
        <p className='p1'>Copyright 2021 All rights Reserved! Designed by </p>
      ...
      <div className='flex-item-middle'>
        ...
        <div className='emailcontainer'>
          <button className='forwardbtn'><IoChevronForwardSharp/></button>
        </div>
      </div>
